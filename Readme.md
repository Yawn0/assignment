...
### **Problem 4: Smart Contract Developer Challenge**
**Basic User Registration Smart Contract**
```bash
- Objective: Create a Solidity contract where users can register with their address.

- Location: Create a test.sol in backend side and write the code there

  The contract should:
  Allow each user to register once
  Store the user's address and a username (string)
...
### **Problem 5: Golang Developer Challenge**
...
### **Problem 6: DevOps Engineer Challenge**
